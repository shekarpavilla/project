...
int main(){
    ...
    struct User users[5] = {
        {"shekar1", "shekar1"}, {"samer2", "samer2"}, {"shiva3", "shiva3"}, {"vyshu4", "vyshu4"}, {"roja5", "roja5"},
    };
    int numUsers = 5;

    // Initialize bus data
    struct Bus buses[3] = {
        {101, "HYDERABAD", "GOA", 50, 50, 500.0},
        {102, "VYZAG", "HYDERABAD", 40, 40, 400.0},
        {103, "GOA", "DELHI", 30, 30, 300.0},
    };
    int numBuses = 3;
